...
const LICENSES: Array<{ name: string; version: string; license: string }> = [
  { name: '@10play/tentap-editor', version: '1.0.1', license: 'MIT' },
  ...
  { name: 'expo-asset', version: '12.0.13', license: 'MIT' },
  { name: 'expo-crypto', version: '15.0.7', license: 'MIT' },
  { name: 'expo-document-picker', version: '14.0.8', license: 'MIT' },
  ...
  { name: 'expo-image-picker', version: '16.1.4', license: 'MIT' },
  { name: 'expo-print', version: '14.1.4', license: 'MIT' },
  ...
  { name: 'pdf-lib', version: '1.17.1', license: 'MIT' },
  ...
  { name: 'react-native-google-mobile-ads', version: '16.3.4', license: 'Apache-2.0' },
  ...
  { name: 'react-native-webview', version: '13.16.0', license: 'MIT' },
