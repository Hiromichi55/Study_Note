...
//   },
  ...
  //   const styles = {
  //   chapterText: { fontSize: 24, fontWeight: 'bold', marginVertical: 8 },
  //   sectionText: { fontSize: 20, fontWeight: '600', marginVertical: 6 },
  //   subsectionText: { fontSize: 18, fontWeight: '500', marginVertical: 4 },
  //   wordBox: { marginVertical: 6, padding: 6, backgroundColor: '#f0f8ff', borderRadius: 8 },
  //   wordTitle: { fontSize: 16, fontWeight: 'bold' },
  //   wordExplanation: { fontSize: 14, color: '#333' },
  //   imageStyle: { width: '100%', height: 200, marginVertical: 8, borderRadius: 12 },
  //   normalText: { fontSize: 16, lineHeight: 24, marginVertical: 2 },
  // };
});
